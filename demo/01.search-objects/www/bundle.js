// Generated by Haxe 3.3.0 (git build development @ 36836e6)
	...
	,onSearchInput: function(e) {
		...
		if(this.opts.populateSuggestions != null) {
			...
			thx_promise__$Promise_Promise_$Impl_$.always(thx_promise__$Promise_Promise_$Impl_$.success(this.polulateSuggestion(this.input.value),function(o) {
				if(o.query != _gthis.input.value) {
					return;
				}
				_gthis.list.setSuggestions(o.list);
			}),function() {
...
thx_promise_Future.prototype = {
	...
	,setState: function(newstate) {
		...
		switch(_g[1]) {
		case 0:
			throw new thx_Error("future was already \"" + Std.string(_g[2]) + "\", can't apply the new state \"" + Std.string(newstate) + "\"",null,{ fileName : "Future.hx", lineNumber : 114, className : "thx.promise.Future", methodName : "setState"});
			break;
		case 1:
...
thx_promise__$Promise_Promise_$Impl_$.map = function(this1,success) {
	return thx_promise__$Promise_Promise_$Impl_$.mapEitherFuture(this1,function(v) {
		try {
			...
			haxe_CallStack.lastException = e;
			if (e instanceof js__$Boot_HaxeError) e = e.val;
			return thx_promise__$Promise_Promise_$Impl_$.error(thx_Error.fromDynamic(e,{ fileName : "Promise.hx", lineNumber : 186, className : "thx.promise._Promise.Promise_Impl_", methodName : "map"}));
		}
	},function(err) {
