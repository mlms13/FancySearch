// Generated by Haxe 3.4.0 (git build development @ c4d2ebb)
...
fancy_search_defaults_AllString.sync = function(opts) {
	...
	opts_filter = thx_Strings.caseInsensitiveContains;
	opts_limit = opts.limit;
	opts_sugEq = function(a0,a1) {
...
fancy_search_renderer_DoomAutocomplete.renderMenu = function(cfg,dispatch,state) {
	...
	case 1:
		if(_g[2][1] == 3) {
			...
			var a2 = dispatch;
			var a3 = highlighted;
			var children = function(a4) {
				return fancy_search_renderer_DoomAutocomplete.renderMenuItem(eq,a1,a2,a3,a4);
			};
...
fancy_search_renderer_DoomAutocomplete.renderMenuItem = function(eq,cfg,dispatch,highlighted,item) {
	...
	return doom_core__$VNode_VNode_$Impl_$.el("li",_g,doom_core__$VNodes_VNodes_$Impl_$.children([cfg.renderSuggestion(item)]));
};
