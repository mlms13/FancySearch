...
$hxClasses["doom.core.IRender"] = doom_core_IRender;
...
$hxClasses["doom.html.Render"] = doom_html_Render;
...
$hxClasses["doom.html._Render.DomComponentMap"] = doom_html__$Render_DomComponentMap;
...
Main.__name__ = ["Main"];
Main.main = function() {
	var foods = ["Apple","Banana","Barley","Black Bean","Carrot","Corn","Cucumber","Dates","Eggplant","Fava Beans","Kale","Lettuce","Lime","Lima Bean","Mango","Melon","Orange","Peach","Pear","Pepper","Potato","Radish","Spinach","Tomato","Turnip","Zucchini"];
	var search = new fancy_Search(fancy_search_defaults_AllString.sync({ suggestions : foods}));
	var rendererConfig = { renderSuggestion : function(sugg,filter) {
		return doom_core__$VNode_VNode_$Impl_$.el("span",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(sugg,null,null)]));
	...
	var vnodes = search.store.stream().map(function(state) {
		return fancy_search_renderer_DoomAutocomplete.render({ state : state, cfg : rendererConfig, dispatch : dispatch, placeholder : "Search for something"});
	});
	Doom.browser.stream(vnodes,window.document.querySelector(".fancy-container"));
};
Math.__name__ = ["Math"];
...
$hxClasses["doom.core._AttributeValue.AttributeValue_Impl_"] = doom_core__$AttributeValue_AttributeValue_$Impl_$;
...
var doom_core_AttributeValueImpl = $hxClasses["doom.core.AttributeValueImpl"] = { __ename__ : ["doom","core","AttributeValueImpl"], __constructs__ : ["BoolAttribute","StringAttribute","EventAttribute"] };
...
doom_core_AttributeValueImpl.__empty_constructs__ = [];
var doom_core_Component = function(props,children) {
	this.isUnmounted = false;
	this.props = props;
	this.children = children;
};
$hxClasses["doom.core.Component"] = doom_core_Component;
...
$hxClasses["doom.core.Renderable"] = doom_core_Renderable;
...
$hxClasses["doom.core.SelectorParser"] = doom_core_SelectorParser;
...
$hxClasses["doom.core._VNode.VNode_Impl_"] = doom_core__$VNode_VNode_$Impl_$;
...
var doom_core_VNodeImpl = $hxClasses["doom.core.VNodeImpl"] = { __ename__ : ["doom","core","VNodeImpl"], __constructs__ : ["Element","Comment","Raw","Text","Comp","Lazy"] };
...
doom_core_VNodeImpl.__empty_constructs__ = [];
var doom_core__$VNodes_VNodes_$Impl_$ = {};
$hxClasses["doom.core._VNodes.VNodes_Impl_"] = doom_core__$VNodes_VNodes_$Impl_$;
...
var doom_html_AttributeType = $hxClasses["doom.html.AttributeType"] = { __ename__ : ["doom","html","AttributeType"], __constructs__ : ["BooleanAttribute","Property","BooleanProperty","OverloadedBooleanAttribute","NumericAttribute","PositiveNumericAttribute","SideEffectProperty"] };
...
doom_html_AttributeType.__empty_constructs__ = [doom_html_AttributeType.BooleanAttribute,doom_html_AttributeType.Property,doom_html_AttributeType.BooleanProperty,doom_html_AttributeType.OverloadedBooleanAttribute,doom_html_AttributeType.NumericAttribute,doom_html_AttributeType.PositiveNumericAttribute,doom_html_AttributeType.SideEffectProperty];
var doom_html_Attributes = function() { };
$hxClasses["doom.html.Attributes"] = doom_html_Attributes;
...
$hxClasses["doom.html.Component"] = doom_html_Component;
...
doom_html_Component.prototype = $extend(doom_core_Component.prototype,{
	...
	,__properties__: {get_element:"get_element"}
});
var doom_html__$EventHandler_EventHandler_$Impl_$ = {};
$hxClasses["doom.html._EventHandler.EventHandler_Impl_"] = doom_html__$EventHandler_EventHandler_$Impl_$;
...
$hxClasses["doom.html.Html"] = doom_html_Html;
...
dots_AttributeType.__empty_constructs__ = [dots_AttributeType.BooleanAttribute,dots_AttributeType.Property,dots_AttributeType.BooleanProperty,dots_AttributeType.OverloadedBooleanAttribute,dots_AttributeType.NumericAttribute,dots_AttributeType.PositiveNumericAttribute,dots_AttributeType.SideEffectProperty];
var dots_Attributes = function() { };
$hxClasses["dots.Attributes"] = dots_Attributes;
...
dots_Dom.getOffsetHeight = function(el) {
...
dots_Dom.getOffsetWidth = function(el) {
...
$hxClasses["dots._EventHandler.EventHandler_Impl_"] = dots__$EventHandler_EventHandler_$Impl_$;
...
var dots_Key = $hxClasses["dots.Key"] = { __ename__ : ["dots","Key"], __constructs__ : ["Printing","NamedPrinting","NonPrinting","Unknown"] };
dots_Key.Printing = function($char,isNumPad) { var $x = ["Printing",0,$char,isNumPad]; $x.__enum__ = dots_Key; return $x; };
dots_Key.NamedPrinting = function(namedChar) { var $x = ["NamedPrinting",1,namedChar]; $x.__enum__ = dots_Key; return $x; };
dots_Key.NonPrinting = function(key) { var $x = ["NonPrinting",2,key]; $x.__enum__ = dots_Key; return $x; };
dots_Key.Unknown = function(key,code,keyCode,which) { var $x = ["Unknown",3,key,code,keyCode,which]; $x.__enum__ = dots_Key; return $x; };
dots_Key.__empty_constructs__ = [];
var dots_NamedCharacter = $hxClasses["dots.NamedCharacter"] = { __ename__ : ["dots","NamedCharacter"], __constructs__ : ["Multiply","Add","Subtract","DecimalPoint","Divide","Tab","Enter","Backspace","Delete"] };
...
dots_NamedCharacter.__empty_constructs__ = [dots_NamedCharacter.Multiply,dots_NamedCharacter.Add,dots_NamedCharacter.Subtract,dots_NamedCharacter.DecimalPoint,dots_NamedCharacter.Divide,dots_NamedCharacter.Tab,dots_NamedCharacter.Enter,dots_NamedCharacter.Backspace,dots_NamedCharacter.Delete];
var dots_IsNumpad = $hxClasses["dots.IsNumpad"] = { __ename__ : ["dots","IsNumpad"], __constructs__ : ["Numpad","NotNumpad","Unknown"] };
...
dots_IsNumpad.__empty_constructs__ = [dots_IsNumpad.Numpad,dots_IsNumpad.NotNumpad,dots_IsNumpad.Unknown];
var dots_MetaOrOS = $hxClasses["dots.MetaOrOS"] = { __ename__ : ["dots","MetaOrOS"], __constructs__ : ["Meta","OS"] };
...
dots_MetaOrOS.__empty_constructs__ = [dots_MetaOrOS.Meta,dots_MetaOrOS.OS];
var dots_LeftOrRight = $hxClasses["dots.LeftOrRight"] = { __ename__ : ["dots","LeftOrRight"], __constructs__ : ["Left","Right","NA","Unknown"] };
...
dots_LeftOrRight.__empty_constructs__ = [dots_LeftOrRight.Left,dots_LeftOrRight.Right,dots_LeftOrRight.NA,dots_LeftOrRight.Unknown];
var dots_NonPrinting = $hxClasses["dots.NonPrinting"] = { __ename__ : ["dots","NonPrinting"], __constructs__ : ["Break","Escape","PageUp","PageDown","End","Home","LeftArrow","UpArrow","RightArrow","DownArrow","Insert","F","Select","ContextMenu","NumLock","Modifier"] };
...
dots_NonPrinting.F = function(number) { var $x = ["F",11,number]; $x.__enum__ = dots_NonPrinting; return $x; };
...
dots_NonPrinting.Modifier = function(mod,leftOrRight) { var $x = ["Modifier",15,mod,leftOrRight]; $x.__enum__ = dots_NonPrinting; return $x; };
dots_NonPrinting.__empty_constructs__ = [dots_NonPrinting.Break,dots_NonPrinting.Escape,dots_NonPrinting.PageUp,dots_NonPrinting.PageDown,dots_NonPrinting.End,dots_NonPrinting.Home,dots_NonPrinting.LeftArrow,dots_NonPrinting.UpArrow,dots_NonPrinting.RightArrow,dots_NonPrinting.DownArrow,dots_NonPrinting.Insert,dots_NonPrinting.Select,dots_NonPrinting.ContextMenu,dots_NonPrinting.NumLock];
var dots_Modifier = $hxClasses["dots.Modifier"] = { __ename__ : ["dots","Modifier"], __constructs__ : ["Alt","CapsLock","Control","MetaOrOS","ScrollLock","Shift"] };
...
dots_Modifier.MetaOrOS = function(which) { var $x = ["MetaOrOS",3,which]; $x.__enum__ = dots_Modifier; return $x; };
...
dots_Modifier.__empty_constructs__ = [dots_Modifier.Alt,dots_Modifier.CapsLock,dots_Modifier.Control,dots_Modifier.ScrollLock,dots_Modifier.Shift];
...
$hxClasses["dots.SelectorParser"] = dots_SelectorParser;
...
$hxClasses["dots.Style"] = dots_Style;
...
var fancy_Search = function(config) {
	...
	var middleware = thx_stream__$Reducer_Middleware_$Impl_$.compose(thx_stream__$Reducer_Middleware_$Impl_$.empty(),this.loadSuggestions(config));
...
fancy_Search.prototype = {
	store: null
	,values: null
	,loadSuggestions: function(config) {
		var _gthis = this;
		return function(state,action,dispatch) {
			...
			if(_g1[1] == 0) {
				if(_g[1] == 1) {
					...
					case 0:case 2:
						var h = _g[3];
						thx_promise__$Promise_Promise_$Impl_$.failure(thx_promise__$Promise_Promise_$Impl_$.success(config.filterer(state.filter),function(results) {
							if(state.config.filterEq(state.filter,_gthis.store.get().filter)) {
								var tmp = fancy_search_Action.PopulateSuggestions(thx__$Nel_Nel_$Impl_$.fromArray(results),h);
								dispatch(tmp);
							}
							return;
						}),function(_) {
...
var fancy_search_config_AllowMenu = $hxClasses["fancy.search.config.AllowMenu"] = { __ename__ : ["fancy","search","config","AllowMenu"], __constructs__ : ["Allow","Disallow"] };
fancy_search_config_AllowMenu.Allow = ["Allow",0];
fancy_search_config_AllowMenu.Allow.__enum__ = fancy_search_config_AllowMenu;
fancy_search_config_AllowMenu.Disallow = function(reason) { var $x = ["Disallow",1,reason]; $x.__enum__ = fancy_search_config_AllowMenu; return $x; };
fancy_search_config_AllowMenu.__empty_constructs__ = [fancy_search_config_AllowMenu.Allow];
...
fancy_search_defaults_AllString.filterStringsSync = function(all,limit) {
	return fancy_search_defaults_AutocompleteDefaults.filterSync(all,thx_Strings.caseInsensitiveContains,limit);
};
fancy_search_defaults_AllString.sync = function(opts) {
	var opts_initValue;
	var opts_initFilter;
	var opts_suggestions = opts.suggestions;
	var opts_filter = thx_Strings.caseInsensitiveContains;
	var opts_limit = opts.limit;
	var opts_sugEq = function(a0,a1) {
		return thx__$Ord_Ord_$Impl_$.equal(thx_Strings.order,a0,a1);
	};
	var opts_minLength = opts.minLength;
	var opts_alwaysHighlight = opts.alwaysHighlight;
...
var fancy_search_defaults_StringOrValue = $hxClasses["fancy.search.defaults.StringOrValue"] = { __ename__ : ["fancy","search","defaults","StringOrValue"], __constructs__ : ["Raw","Value"] };
fancy_search_defaults_StringOrValue.Raw = function(val,prev) { var $x = ["Raw",0,val,prev]; $x.__enum__ = fancy_search_defaults_StringOrValue; return $x; };
fancy_search_defaults_StringOrValue.Value = function(val) { var $x = ["Value",1,val]; $x.__enum__ = fancy_search_defaults_StringOrValue; return $x; };
fancy_search_defaults_StringOrValue.__empty_constructs__ = [];
...
fancy_search_defaults_AutocompleteDefaults.create = function(filterer,sugEq,toValue,initValue,initFilter,minLength,alwaysHighlight) {
	...
	return { filterer : filterer, sugEq : sugEq, filterEq : function(a0,a1) {
		return thx__$Ord_Ord_$Impl_$.equal(thx_Strings.order,a0,a1);
	...
	}, alwaysHighlight : alwaysHighlight, initValue : thx_Options.cata(initValue,fancy_search_defaults_StringOrValue.Raw("",haxe_ds_Option.None),fancy_search_defaults_StringOrValue.Value), initFilter : initFilter, getValue : function(highlight,filter1,curr) {
		return thx_Options.cata(thx_Options.map(highlight,toValue),fancy_search_defaults_StringOrValue.Raw(filter1,fancy_search_defaults_AutocompleteDefaults.getValue(curr)),fancy_search_defaults_StringOrValue.Value);
	}};
};
fancy_search_defaults_AutocompleteDefaults.getValue = function(x) {
	switch(x[1]) {
	case 0:
		var val = x[3];
		return val;
	case 1:
		var val1 = x[2];
		return haxe_ds_Option.Some(val1);
	}
};
fancy_search_defaults_AutocompleteDefaults.filterSync = function(all,condition,limit) {
	return function(search) {
		...
		if(thx_Strings.isEmpty(search)) {
			...
			var f = condition;
			var a2 = search;
			var filtered1 = function(a1) {
				return f(a1,a2);
			};
			filtered = all.filter(filtered1);
		}
		return thx_promise__$Promise_Promise_$Impl_$.value(thx_Options.cata(limit,filtered,function(_) {
			return filtered.slice(0,_);
		}));
	};
};
...
fancy_search_defaults_ClassNameDefaults.__name__ = ["fancy","search","defaults","ClassNameDefaults"];
...
var fancy_search_defaults_KeyboardDefaults = function() { };
$hxClasses["fancy.search.defaults.KeyboardDefaults"] = fancy_search_defaults_KeyboardDefaults;
fancy_search_defaults_KeyboardDefaults.__name__ = ["fancy","search","defaults","KeyboardDefaults"];
var fancy_search_renderer_DoomAutocomplete = function() { };
$hxClasses["fancy.search.renderer.DoomAutocomplete"] = fancy_search_renderer_DoomAutocomplete;
...
fancy_search_renderer_DoomAutocomplete.render = function(props) {
	...
	return doom_core__$VNode_VNode_$Impl_$.el("div",null,doom_core__$VNodes_VNodes_$Impl_$.children([fancy_search_renderer_DoomAutocomplete.renderInput(props.cfg.keys,props.cfg.classes,props.placeholder,props.dispatch,captureKeys,props.state.filter),fancy_search_renderer_DoomAutocomplete.renderMenu(props.cfg,props.dispatch,props.state)]));
};
fancy_search_renderer_DoomAutocomplete.renderInput = function(keys,classes,placeholder,dispatch,captureKeys,value) {
	var _g = new haxe_ds_StringMap();
	var value1 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("fancify " + classes.input);
	...
	if(__map_reserved["type"] != null) {
		_g.setReserved("type",value2);
	} else {
		_g.h["type"] = value2;
	}
	var value3 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString(placeholder);
	if(__map_reserved["placeholder"] != null) {
		_g.setReserved("placeholder",value3);
	} else {
		_g.h["placeholder"] = value3;
	}
	var value4 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString(value);
	if(__map_reserved["value"] != null) {
		_g.setReserved("value",value4);
	} else {
		_g.h["value"] = value4;
	}
	var f = function(el,_) {
		var inpt = el;
		dispatch(fancy_search_Action.SetFilter(inpt.value));
		dispatch(fancy_search_Action.OpenMenu);
	};
	var value5 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromEventHandler(function(el1,e) {
		f(el1,e);
	});
	if(__map_reserved["focus"] != null) {
		_g.setReserved("focus",value5);
	} else {
		_g.h["focus"] = value5;
	}
	var f1 = function() {
		dispatch(fancy_search_Action.CloseMenu);
	};
	var value6 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromEventHandler(function(el2,e1) {
		e1.preventDefault();
		f1();
	});
	if(__map_reserved["blur"] != null) {
		_g.setReserved("blur",value6);
	} else {
		_g.h["blur"] = value6;
	}
	var f2 = function(el3,_1) {
		var inpt1 = el3;
		dispatch(fancy_search_Action.SetFilter(inpt1.value));
		dispatch(fancy_search_Action.OpenMenu);
	};
	var value7 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromEventHandler(function(el4,e2) {
		f2(el4,e2);
	});
	...
	if(captureKeys) {
		var f3 = function(_2,e3) {
			var keyWithModifier = dots_Keys.getKeyAndModifiers(e3);
			haxe_Log.trace(keyWithModifier,{ fileName : "DoomAutocomplete.hx", lineNumber : 61, className : "fancy.search.renderer.DoomAutocomplete", methodName : "renderInput"});
			haxe_Log.trace(thx_Arrays.contains(keyWithModifier.modifiers,dots_Modifier.Shift,Type.enumEq),{ fileName : "DoomAutocomplete.hx", lineNumber : 62, className : "fancy.search.renderer.DoomAutocomplete", methodName : "renderInput"});
		...
		value8 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromEventHandler(function(el5,e4) {
			f3(el5,e4);
		});
	} else {
		value8 = null;
...
fancy_search_renderer_DoomAutocomplete.renderMenu = function(cfg,dispatch,state) {
	...
	case 0:
		...
		return doom_core__$VNode_VNode_$Impl_$.el("div",_g1,null);
	case 1:
		if(_g[2][1] == 3) {
			...
			var value2 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString(cfg.classes.list);
			if(__map_reserved["class"] != null) {
				_g11.setReserved("class",value2);
			} else {
				_g11.h["class"] = value2;
			}
			var eq = state.config.sugEq;
			var cfg1 = cfg;
			var filter = state.filter;
			var dispatch1 = dispatch;
			var highlighted1 = highlighted;
			var children = function(item) {
				return fancy_search_renderer_DoomAutocomplete.renderMenuItem(eq,cfg1,filter,dispatch1,highlighted1,item);
			};
...
fancy_search_renderer_DoomAutocomplete.renderMenuItem = function(eq,cfg,filter,dispatch,highlighted,item) {
	var highlightClass = thx_Options.cata(highlighted,"",function(h) {
		if(eq(item,h)) {
			return cfg.classes.itemHighlighted;
		} else {
			return "";
		}
	});
	var _g = new haxe_ds_StringMap();
	var value = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString(cfg.classes.item + " " + highlightClass);
	if(__map_reserved["class"] != null) {
	...
	var f = function() {
		dispatch(fancy_search_Action.ChangeHighlight(fancy_search_HighlightChangeType.Specific(item)));
		return;
	};
	...
	if(__map_reserved["mouseover"] != null) {
		_g.setReserved("mouseover",value1);
	} else {
		_g.h["mouseover"] = value1;
	}
	var f1 = function() {
		dispatch(fancy_search_Action.ChooseCurrent);
		return;
	};
	var value2 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromEventHandler(function(el1,e1) {
		e1.preventDefault();
		f1();
	});
	if(__map_reserved["mousedown"] != null) {
		_g.setReserved("mousedown",value2);
	} else {
		_g.h["mousedown"] = value2;
	}
	return doom_core__$VNode_VNode_$Impl_$.el("li",_g,doom_core__$VNodes_VNodes_$Impl_$.children([cfg.renderSuggestion(item,filter)]));
};
...
$hxClasses["thx._Char.Char_Impl_"] = thx__$Char_Char_$Impl_$;
...
$hxClasses["thx._Result.Result_Impl_"] = thx__$Result_Result_$Impl_$;
...
$hxClasses["thx.error.AbstractMethod"] = thx_error_AbstractMethod;
...
$hxClasses["thx.fp.Functions"] = thx_fp_Functions;
...
$hxClasses["thx.promise.Future"] = thx_promise_Future;
...
$hxClasses["thx.promise.Futures"] = thx_promise_Futures;
...
$hxClasses["thx.promise.FutureTuple6"] = thx_promise_FutureTuple6;
...
$hxClasses["thx.promise.FutureTuple5"] = thx_promise_FutureTuple5;
...
$hxClasses["thx.promise.FutureTuple4"] = thx_promise_FutureTuple4;
...
$hxClasses["thx.promise.FutureTuple3"] = thx_promise_FutureTuple3;
...
$hxClasses["thx.promise.FutureTuple2"] = thx_promise_FutureTuple2;
...
$hxClasses["thx.promise.FutureNil"] = thx_promise_FutureNil;
...
$hxClasses["thx.promise._Promise.Promise_Impl_"] = thx_promise__$Promise_Promise_$Impl_$;
thx_promise__$Promise_Promise_$Impl_$.__name__ = ["thx","promise","_Promise","Promise_Impl_"];
thx_promise__$Promise_Promise_$Impl_$.__properties__ = {get_nil:"get_nil"};
...
thx_promise__$Promise_Promise_$Impl_$.nil = null;
...
$hxClasses["thx.promise.Promises"] = thx_promise_Promises;
...
$hxClasses["thx.promise.PromiseTuple6"] = thx_promise_PromiseTuple6;
...
$hxClasses["thx.promise.PromiseTuple5"] = thx_promise_PromiseTuple5;
...
$hxClasses["thx.promise.PromiseTuple4"] = thx_promise_PromiseTuple4;
...
$hxClasses["thx.promise.PromiseTuple3"] = thx_promise_PromiseTuple3;
...
$hxClasses["thx.promise.PromiseTuple2"] = thx_promise_PromiseTuple2;
...
$hxClasses["thx.promise.PromiseNil"] = thx_promise_PromiseNil;
...
$hxClasses["thx.promise.PromiseAPlus"] = thx_promise_PromiseAPlus;
...
$hxClasses["thx.promise.PromiseAPlusVoid"] = thx_promise_PromiseAPlusVoid;
...
$hxClasses["thx.promise.Timer"] = thx_promise_Timer;
...
fancy_search_defaults_KeyboardDefaults.defaults = { highlightUp : function(keyWithMod) {
	switch(keyWithMod.key[1]) {
	case 1:
		if(keyWithMod.key[2][1] == 5) {
			var m = keyWithMod.modifiers;
			if(thx_Arrays.contains(m,dots_Modifier.Shift)) {
				return true;
			} else {
				return false;
			}
...
}, highlightDown : function(keyWithMod1) {
	switch(keyWithMod1.key[1]) {
	case 1:
		if(keyWithMod1.key[2][1] == 5) {
			var m1 = keyWithMod1.modifiers;
			if(!thx_Arrays.contains(m1,dots_Modifier.Shift)) {
				return true;
			} else {
				return false;
			}
...
}, choose : function(keyWithMod2) {
	if(keyWithMod2.key[1] == 1) {
		if(keyWithMod2.key[2][1] == 6) {
			return true;
		} else {
			return false;
		}
...
}, close : function(keyWithMod3) {
	if(keyWithMod3.key[1] == 2) {
		if(keyWithMod3.key[2][1] == 1) {
			return true;
		} else {
			return false;
		}
