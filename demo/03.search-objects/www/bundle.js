...
Main.main = function() {
	...
	var dispatch = function(act) {
		search.store.dispatch(act,{ fileName : "Main.hx", lineNumber : 23, className : "Main", methodName : "main"});
	};
...
fancy_search_renderer_DoomAutocomplete.render = function(props) {
	...
	var value = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("fancify");
	if(__map_reserved["class"] != null) {
		_g1.setReserved("class",value);
	} else {
		_g1.h["class"] = value;
	}
	return doom_core__$VNode_VNode_$Impl_$.el("div",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core__$VNode_VNode_$Impl_$.el("input",_g1,null)]));
};
