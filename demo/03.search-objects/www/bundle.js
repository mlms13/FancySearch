...
Main.main = function() {
	...
	var vnodes = search.store.stream().map(function(state) {
		return new fancy_search_renderer_DoomStringFilter({ search : search, cfg : rendererConfig}).asNode();
	});
	Doom.browser.stream(vnodes,window.document.getElementById("app"));
};
Math.__name__ = ["Math"];
...
var fancy_search_renderer_DoomStringFilter = function(props,children) {
	doom_html_Component.call(this,props,children);
};
$hxClasses["fancy.search.renderer.DoomStringFilter"] = fancy_search_renderer_DoomStringFilter;
fancy_search_renderer_DoomStringFilter.__name__ = ["fancy","search","renderer","DoomStringFilter"];
fancy_search_renderer_DoomStringFilter.__super__ = doom_html_Component;
fancy_search_renderer_DoomStringFilter.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		return doom_core__$VNode_VNode_$Impl_$.el("div",null,null);
	}
	,classes: function() {
		return "fancy_search_renderer_doom-string-filter";
	}
	,__class__: fancy_search_renderer_DoomStringFilter
});
