...
Main.main = function() {
	var options = { minLength : 0, suggestionOptions : { suggestions : ["Amazon","Angellist","Apple","Facebook","Foursquare","Github","Google","Linkedin","Twitter","Vimeo"], limit : 6, showSearchLiteralItem : true, suggestionToElement : function(v) {
		...
		var children = dots_Dom.parse("i.fa.fa-" + v.toLowerCase() + "[style=color:#000]",null,null,null,null);
		var doc1 = null;
		if(null == doc1) {
		...
		var _g2 = 0;
		var _g11 = [{ value : "fs-suggestion-highlight", name : "class"},{ value : "color:#999", name : "style"}];
		...
		if(null != textContent1) {
			el.appendChild(doc.createTextNode(textContent1));
		}
		return el;
	}}};
