...
Main.__name__ = true;
Main.main = function() {
	var search = fancy_Search.createFromSelector(".fancy-container input",{ minLength : 0, suggestionOptions : { suggestions : ["Amazon","Angellist","Apple","Facebook","Foursquare","Github","Google","Linkedin","Twitter","Vimeo"], limit : 6, showSearchLiteralItem : true, suggestionToElement : function(v) {
		var doc = null;
		if(null == doc) {
			doc = window.document;
		}
		...
		var tmp1 = dots_Dom.parse("i.fa.fa-" + v.toLowerCase() + "[style=color:#000]",null,null,null,null);
		var doc1 = null;
		if(null == doc1) {
